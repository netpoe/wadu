      ...
      <div class="col top-menu-left">
        <div class="top-menu-item">
          ...
          <ul class="top-menu-dropdown">
            ...
            <li class="top-menu-sub-item"><a href="{{ route('admin.orders.new') }}">{{ __('All orders') }}</a></li>
            <li class="top-menu-sub-item"><a href="{{ route('admin.orders.new') }}">{{ __('Ready for processing') }}</a></li>
            <li class="top-menu-sub-item"><a href="{{ route('admin.orders.new') }}">{{ __('Ready to ship') }}</a></li>
          </ul>
        </div>
        <div class="top-menu-item">
